...
const slug:NextPage = () => {
  ...
  return (
    ...
    {user?.username === slug ? (
      ...
      <div className="flex flex-col items-center md:pr-20 space-y-6">
    ...
    <form onSubmit={handleSubmit(onSubmit)}>
      <div className="flex space-x-10 space-around pb-10 md:pb-0 justify-center mx-auto ">
      <div className="flex  flex-col">
        ...
        {isEditing ? ( 
          ...
          <h2 className="max-w-[180px] pt-7 text-sm text-third">You're part of Pawstore community since July 7h 2022</h2>
        )}

      </div>
      <div className="flex  flex-col">

        <h2 className="font-semibold text-primary">City</h2>
        ...
        <h2  className="font-semibold pt-4 text-primary">Phone Number</h2>
        ...
        <h2 className="font-semibold pt-4 text-primary">Email</h2>
        <input className="profile-button" 
        disabled placeholder={`${user?.email}`}/>
        
        <div className="flex pt-4 flex-col text-red-500">
