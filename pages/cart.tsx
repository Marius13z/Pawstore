...
const cart:NextPage = () => {
  ...
  return (
   <div>
    ...
    <div className="flex flex-col max-w-4xl mx-auto space-y-10 lg:items-start items-center">
  ...
  <div className="flex justify-center pt-10 space-x-4 items-center">
   ...
   name={product?.data().name}/>     
      ...
      <div className="sticky border-0  lg:w-[300px] pt-5 pb-5 sm:mr-16 lg:border-primary lg:bottom-[300px]
